    ...
    {literal}
      $(document).ready(function(){  
        ...
        $(".well input[type='checkbox']").on('change', function(){
            ...
            toastr.info( "Its value: "+this_value );
            ...
            $.ajax({
                 type: "POST",
                 url: "{/literal}{$baseurl}calendar/calendar_tasks/{literal}", 
        ...
        $(".table a.close-button").on('click', function(){
            ...
            $.ajax({
                 type: "POST",
                 url: "{/literal}{$baseurl}calendar/remove/{literal}'); ?>",  
                 // url: "/calendar/remove/", 
                 data: {id: this_date  },
                 dataType: "text",  
                 cache:false,
        ...
        $(".images-well a.remove-image-link").on('click', function(){
            ...
            $.ajax({
                 type: "POST",
                 url: "{/literal}{$baseurl}upload/delete_image/{literal}'); ?>",  
                 data: {id: this_id  },
                 dataType: "text",  
                 cache:false,
                 beforeSend : function (){
        ...
        window.setTimeout(function() { $(".alert.fade.in").hide(1000); }, 5000);         
